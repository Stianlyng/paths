...
public class FrontendUtils {
  ...
  public static String[] splitTextIntoFourLines(
    String[] conversationParts,
    int conversationPaneNumber,
    ...
    List<String[]> wordGroups = IntStream
      .range(0, numGroups)
      .mapToObj(i -> {
        int startIndex = i * 10;
    ...
    String[] textLines = IntStream
      .range(0, Math.min(numGroups, 4))
