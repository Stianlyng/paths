...
public class Story implements Serializable{
   ...
   * It should not be possible to remove the passage if there are other passages that link to it.
  ...
  /**
   * Finds and returns a list of dead links. A link is dead if it refers to a passage that does not exist in passages.
   *
