...
public class FirstScene {
    public static Scene scene(String title) throws FileNotFoundException{
        Text lvlText = ApplicationObjects.newText(title, 40, false, 541-193, 349-71);
        HBox layout = new HBox(lvlText);
        layout.setAlignment(Pos.CENTER); //fix center av skjerm. funker å bruker layout i group
