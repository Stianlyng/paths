...
public class ConversationPane extends StackPane {
  ...
  public static void addChoiceObjects(ConversationPane pane) throws FileNotFoundException {
    Button choiceOneButton = ViewObjects.newButton(
      passage.getLinks().get(0).getText(),
      71,
      212,
      "talk_button",
      "talk_hover",
      controller::choiceOneAction
    );
    Button choiceTwoButton = ViewObjects.newButton(
      passage.getLinks().get(1).getText(),
      318,
      212,
      "talk_button",
      "talk_hover",
      controller::choiceTwoAction
    );
  ...
  public static Group getConversationPaneObjects() throws FileNotFoundException {
    ImageView enemyImage = ViewObjects.newImage(
      ...
      150,
      150,
      controller::conversationPaneClickedAction
    );
    ...
    ImageView coinIcon = ViewObjects.newImage(
      "icons",
      "coin.png",
      116,
      65,
    ...
    ImageView healthIcon = ViewObjects.newImage(
      "icons",
      "heart.png",
      295,
      65,
    ...
    ImageView scoreIcon = ViewObjects.newImage(
      "icons",
      "star.png",
      196,
      65,
    ...
    MenuButton dropDownMenu = ViewObjects.newMenuButton(
    ...
    Text scoreText = ViewObjects.newText(
    ...
    Text goldText = ViewObjects.newText(
    ...
    Text healthText = ViewObjects.newText(
    ...
    ChoiceBox inventory = ViewObjects.newChoiceBox(
      ConversationPaneController.getPlayerInventoryItems(),
      724,
      58,
      "inventory_choicebox"
    );

    Rectangle infoBoard = ViewObjects.newRectangle(
      110,
      58,
      293,
      38,
    ...
    Text conversationTextLineOne = ViewObjects.newText(
      textline[0],
      24,
      false,
      140,
    ...
    Text conversationTextLineTwo = ViewObjects.newText(
      textline[1],
      24,
      false,
      140,
    ...
    Text conversationTextLineThree = ViewObjects.newText(
      textline[2],
      24,
      false,
      140,
    ...
    Text conversationTextLineFour = ViewObjects.newText(
      textline[3],
      24,
      false,
      140,
    ...
    Group root = new Group(
      ...
      goldText,
      healthText,
      conversationTextLineOne,
      conversationTextLineTwo,
      conversationTextLineThree,
      conversationTextLineFour,
      dropDownMenu,
      inventory
    );

    if (
      ConversationPaneController.getTypeInCurrentConversationPane() == null ||
      ConversationPaneController.getTypeInCurrentConversationPane().equals("{N}")
    ) {
      ImageView neutralBubble = ViewObjects.newImage(
        "animations",
        "neutralbubble.png",
        134,
        369,
      ...
      ImageView rightBubble = ViewObjects.newImage(
        "animations",
        "righttalkingbubble.png",
        134,
        369,
        793,
        722,
      ...
      ImageView leftBubble = ViewObjects.newImage(
        "animations",
        "lefttalkingbubble.png",
        134,
        369,
        793,
        722,
