...
public class ContinueGamePane extends StackPane {
  ...
  public static Group getContinueSceneObjects() throws IOException {
    Button save1Button = ViewObjects.newBlankButton(
      "",
      421,
      207,
    ...
    Button save2Button = ViewObjects.newBlankButton(
      "",
      421,
      274,
      ViewValues.MENU_BUTTON_ID,
    ...
    Button save3Button = ViewObjects.newBlankButton(
      "",
      421,
      341,
      ViewValues.MENU_BUTTON_ID,
    ...
    Button deleteSaves = ViewObjects.newButton(
      "Delete all saves",
      120,
      524,
      "delete_button",
      "delete_hover",
      controller::deleteAllPlayerSavesAction
    );
    ...
    Button backButton = ViewObjects.newButton(
      ...
      controller::goToOpeningPaneAction
    );
